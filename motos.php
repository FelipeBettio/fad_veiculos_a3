...
<head>
    ...
    <title>Fad Veiculos - Motos</title>
...
<body style="background-color:#DC3545">
    ...
    <div id="header" class="shadow p-1 mb-5">
        ...
        <div class="header-right">
          ...
          <a class="active" href="motos.php">Motos</a>
          <a class="font" href="admin.php">Admin</a>
        </div>
      </div>
    
    <div class="container w-auto p-4" style="background-color:#F5F5F5">
    <h1 class="display-2 mt-3 mb-5">Motos</h1>

        
    <?php
        $query_carros = "SELECT idCar, tipo, modelo, ano, cor, preco, imagem1, imagem2, imagem3, descricao FROM carros WHERE tipo = 'moto' ORDER BY idCar ASC";
